...
MODULE_DESCRIPTION("A simple rgb dynamic lapsing module similar to LineageOS's livedisplay");
MODULE_VERSION("1.0"); 
...
static DEVICE_ATTR(daytime_r, 0666, daytime_r_show, daytime_r_dump);
static DEVICE_ATTR(daytime_g, 0666, daytime_g_show, daytime_g_dump);
static DEVICE_ATTR(daytime_b, 0666, daytime_b_show, daytime_b_dump);
static DEVICE_ATTR(target_r, 0666, target_r_show, target_r_dump);
static DEVICE_ATTR(target_g, 0666, target_g_show, target_g_dump);
static DEVICE_ATTR(target_b, 0666, target_b_show, target_b_dump);
static DEVICE_ATTR(klapse_start_hour, 0666, livedisplay_start_hour_show, livedisplay_start_hour_dump);
static DEVICE_ATTR(klapse_stop_hour, 0666, livedisplay_stop_hour_show, livedisplay_stop_hour_dump);
